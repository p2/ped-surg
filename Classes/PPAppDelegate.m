...
{
	// UI setup
	PPMasterViewController *listViewController = [PPMasterViewController new];
	...
	// on iPad
		...
		UINavigationController *masterNavigationController = [[UINavigationController alloc] initWithRootViewController:listViewController];
		
		PPDetailViewController *detailViewController = [PPDetailViewController new];
